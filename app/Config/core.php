 ...
 */
	Configure::write('Exception', array(
		...
		'renderer' => 'ExceptionRenderer', // default: ExceptionRenderer -> AppExceptionRenderer on production
		'log' => true // default: true -> false on production
	));
 ...
 */
	// Configure::write('App.fullBaseUrl', 'http://localhost'); # <== replace with your own domain, no trailing /.
 ...
 */
	# this generates a session ID error on server
 ...
 */
	Configure::write('Security.salt', 'XPnNsYBuvdC71VwJk70JgkMmVW0L8q2KuFBOZd3o2es6jQBaIsBdevqMWVjEMlMD');

/**
 * A random numeric string (digits only) used to encrypt/decrypt strings.
 */
	Configure::write('Security.cipherSeed', '0073434080318204500831476989451179828891');
...
switch(true) {
	...
	default:
		$engine = 'File';
		//$engine = 'Libs.NamespaceFileCache';
		break;
}
Configure::write('Cache.engine', $engine);
...
Cache::config('default', array('engine' => $engine, 'prefix' => $prefix . 'default', 'mask' => 0644));

if (isset($_SERVER['SUBDOMAIN_DOCUMENT_ROOT']) && !empty($_SERVER['SUBDOMAIN_DOCUMENT_ROOT'])) {
	// GoDaddy subdomain fix
