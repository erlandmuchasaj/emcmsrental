...
function SmartWizard(target, options) {
    ...
    this.contentWidth = 0;
    this.msgBox       = $('<div class="msgBox"><div class="msg-content"></div><a href="#" class="close">X</a></div>');
    this.elmStepContainer = $('<div></div>').addClass("stepContainer clearfix");
    ...
    var _init = function($this) {
        ...
        $('.close',$this.msgBox).on('click', function() {
        ...
        allDivs.addClass("wizard-inner-content");
        ...
        $($this.buttons.finish).on('click', function() {
    ...
    var _showStep = function($this, stepIdx) {
        ...
        * Fixed Heght
        */
        // Comment this line if you want the height of the wizard to be dynamic
    ...
    SmartWizard.prototype.showMessage = function (msg) {
        $('.msg-content', this.msgBox).html(msg);
        this.msgBox.show();
    };
