			...
			<div class="col-md-9">
				<div class="fileinput fileinput-new" data-provides="fileinput">
					<div class="fileinput-new thumbnail" style="max-width: 200px; max-height: 150px;">
						<?php
							$image_path = (isset($this->request->data['CityPlace']['image_path'])) ? $this->request->data['CityPlace']['image_path'] : '' ;
							if (file_exists($directory.$image_path) && is_file($directory.$image_path)) {
								echo $this->Html->image('uploads/CityPlace/'.$image_path, array('alt' => 'image_path', 'class'=>'img-responsive')); 
							} else {
