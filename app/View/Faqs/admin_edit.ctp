	    ...
	    <div class="col-md-12">
	        <div class="panel panel-em">
	            ...
	            <div class="panel-body">
                	<?php
						echo $this->Form->create('Faq',array('class'=>'form-horizontal bucket-form'));
						echo $this->Form->input('id');
                	?>
		                <div class="form-group">
		                    <label class="col-md-2 control-label"><?php echo __('Question');?></label>
		                    <div class="col-md-6">
		                        <?php echo $this->Form->input('question', array('label'=>false, 'div'=>false,'class'=>'form-control','placeholder'=>'question')); ?>
