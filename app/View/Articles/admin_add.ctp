...
<!-- page start-->
	<div class="panel panel-em">
		<header class="panel-heading">
		   <?php echo $this->Html->tag('h4', __('Add Article'), array('class'=>'')); ?>
		</header>
		<div id="article_managment_form" class="panel-body">
			<?php echo $this->Form->create('Article',array('type'=>'file','class'=>'form-horizontal')); ?>
			...
			<div class="form-group">
				<div class="col-lg-12">
					<?php echo $this->Form->submit(__('Save Article'), array('class'=>'btn btn-info','label'=>false,'div'=>false)); ?>
