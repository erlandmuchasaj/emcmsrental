...
<article class="panel panel-em">
	<header class="panel-heading">
		<?php  echo __('Add Banner'); ?>
	</header>
	<div class="panel-body">
		<?php 
			echo $this->Form->create('Banner',array('type'=>'file', 'class'=>'form-horizontal', 'url'=>array('admin'=>true, 'controller' => 'site_settings', 'action' => 'addBanner'))); 
		?>
