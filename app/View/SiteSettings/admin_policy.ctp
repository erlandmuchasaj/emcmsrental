	            	...
	            	<div class="position-center">
	                	...
	                	?>
			                <div class="form-group">
			                    <label class="col-lg-12"><?php echo __('Policy');?></label>
			                    <div class="col-lg-12">
			                        <?php echo $this->Form->input('policy', array('type'=>'textarea','label'=>false, 'div'=>false,'class'=>'form-control froala')); ?>
			                        <span class="help-block"><?php echo __('Here you can edit Site Policy. ');?></span>
			                    </div>
			                </div>
			                <div class="form-group">
			                    <div class="col-lg-12">
