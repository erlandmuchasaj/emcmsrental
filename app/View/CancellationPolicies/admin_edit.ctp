...
// $retVal = ($this->request->data['CancellationPolicy']['property_days_prior_status']) ? a : b ;
...
<script>
	...
	<?php if ((int)$this->request->data['CancellationPolicy']['property_days_prior_status']==1) { ?>
		toggle_visibility('list_before_days_prior');
	<?php } ?>

	<?php if ((int)$this->request->data['CancellationPolicy']['property_before_status']==1) { ?>
		toggle_visibility('property_before_checkin_days');
	<?php } ?>

	<?php if ((int)$this->request->data['CancellationPolicy']['property_after_status']==1) { ?>
		toggle_visibility('property_after_checkin_days');
	<?php } ?>
</script>