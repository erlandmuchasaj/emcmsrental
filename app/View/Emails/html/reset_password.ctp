	...
	<table style="margin: 0 auto" cellpadding="0" cellspacing="0" class="force-width-80">
		<tr>
			...
			<td class="mobile-resize" style="color:#172838; font-size: 20px; font-weight: 600; text-align: left; vertical-align: top;">
				<?php echo $this->Html->tag('span', __('Reset Password'), array('class'=>'')); ?>
			</td>
		</tr>
	</table>
	...
	<tr>
		<td style="text-align:center; margin:0 auto;">
			...
			<div>
				...
				<center>
				<![endif]-->
				<a class="btn" href="#" style="background-color:#172838;color:#ffffff;display:inline-block;font-family:'Source Sans Pro', Helvetica, Arial, sans-serif;font-size:18px;font-weight:400;line-height:45px;text-align:center;text-decoration:none;width:240px;-webkit-text-size-adjust:none; -webkit-border-radius:3px;-moz-border-radius:3px;border-radius:3px;">Click To Reset Password</a>
				<!--[if mso]>
				</center>
				</v:rect>
				<![endif]-->
