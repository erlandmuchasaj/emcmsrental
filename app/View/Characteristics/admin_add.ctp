...
<article class="panel panel-em">
    <header class="panel-heading">
    	<?php echo $this->Html->tag('h4', __('Add Characteristics'))?>
    </header>
    <div class="panel-body">
    	<?php echo $this->Form->create('Characteristic',array('type'=>'file','class'=>'form-horizontal')); ?>
        	...
        	<div class="col-sm-6">
        		...
        		<?php foreach ($languages as $index => $language): ?>
					...
					<?php 
						...
						echo $this->Form->input('CharacteristicTranslation.' . $id_lang . '.language_id', ['type' => 'hidden', 'value' => $id_lang]); 

						echo $this->Form->input('CharacteristicTranslation.' . $id_lang . '.characteristic_name', $options); 
					?>
        			<?php if (count($languages) > 1): ?>
        				</div>
