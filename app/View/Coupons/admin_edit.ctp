    ...
    <div class="col-md-12">
        <div class="panel panel-em">
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<?php echo $this->Form->input('date_from', array('label'=>false, 'empty'=>__('Select from'), 'div'=>false,'class'=>'form-control')); ?>
				</div>
			</div>
			...
			<div class="form-group">
				...
				<div class="col-md-6">
					<?php echo $this->Form->input('date_to', array('label'=>false, 'empty'=>__('Select to'), 'div'=>false,'class'=>'form-control')); ?>
				</div>
			</div>
